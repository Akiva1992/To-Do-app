...
function showInitialPriorityBtn (){
    console.log("Hello from show init priority btn")
    document.querySelector(".priority.selection-btn").innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="priority-icon" viewBox="0 0 16 16">
...
export { priorityDropDownBindEvents, setPrioritySelection, showInitialPriorityBtn }
